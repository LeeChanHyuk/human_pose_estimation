# -*- coding: utf-8 -*-
"""Pose classification (extended).ipynb의 사본

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19b-GTgnp0xLmjnr92ent3qNyxzfBBpQW
...
class FullBodyPoseEmbedder(object):
  ...
  def __call__(self, landmarks): # pose sample class를 만드니까 자동으로 호출 됨.
    ...
    Args:
      landmarks - NumPy array with 3D landmarks of shape (N, 3). # 3차원이야?
...
#     ...
import os
bootstrap_images_in_folder = os.getcwd() + '/' + 'fitness_poses_images_in'

# Output folders for bootstrapped images and CSVs.
bootstrap_images_out_folder = os.getcwd() + '/' + 'fitness_poses_images_out'
bootstrap_csvs_out_folder = os.getcwd() + '/' + 'fitness_poses_csvs_out'
