...
from gaze_estimation_module.models.layers import Conv, Hourglass, Pool, Residual
from gaze_estimation_module.models.losses import HeatmapLoss
from gaze_estimation_module.util.softargmax import softargmax2d
